...
const gifs = [
    ...
    'https://cdn.discordapp.com/attachments/515812185360957440/539998295557144576/f7d.gif'
];

const sendWelcomeEmbed = (member) => {
    const GeneralChannel = member.guild.channels.find(ch => ch.name === 'general');
    const imageUrl = gifs[Math.floor(Math.random() * 9)];
    const embed = {
